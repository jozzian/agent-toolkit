...
| [Work structure](project-management.md) | Theme (optional), Goal, Milestone, and Task: the planning vocabulary rule 11 of `rules/rules-for-prototyping.md` points to instead of defining inline, built on a required outcome for every goal, milestone, and task. |
