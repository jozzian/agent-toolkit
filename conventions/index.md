...
A convention is a shared standard for structuring, naming, documenting, or
releasing work, applied consistently rather than decided fresh each time.
...
| [Agent Brief](agent-brief.md) | The four-part anatomy (hook, repo deliverable, agent brief, learning goal) for a work-order brief a coding agent can execute cold, and the writing rules that keep it grounded in the real repository. |
...
| [Project Management Vocabulary](project-management.md) | Initiative, Goal, Milestone, and Task — the planning vocabulary rule 11 of `rules/rules-for-prototyping.md` points to instead of defining inline, built on a required outcome for every goal, milestone, and task. |
