...
that file for the stage sequence itself; this wrapper exists only so
Claude Code's skill system can discover it at this path.

Other agent tooling (Codex, OpenCode, or anything else) should read
`patterns/design-pipeline.md` directly instead of expecting an
equivalent wrapper here.
