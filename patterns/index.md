...
type: Index
title: Patterns
description: Catalog of repeatable, staged processes in this toolkit — distinct from the invariant rules in rules/prototyping-system.md.
timestamp: 2026-08-25
---

# Patterns

A pattern is a repeatable set of steps to go through, not a single
invariant — that's what `rules/prototyping-system.md` is for (see that
file's "Why this exists" section for the distinction). Each file below is
one pattern. Expect these to grow and gain detail over time rather than
